defmodule PelicanWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PelicanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PelicanWeb.Gettext, "errors", msg, opts)
    end
  end
